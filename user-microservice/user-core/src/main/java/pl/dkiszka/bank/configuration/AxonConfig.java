...
public class AxonConfig {
    ...
    @Bean
    EventStorageEngine eventStorageEngine(MongoClient mongoClient) {
    ...
    @Bean
    EmbeddedEventStore embeddedEventStore(EventStorageEngine eventStorageEngine, AxonConfiguration axonConfiguration) {
